...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { number_owner: @operation.number_owner, number_sender: @operation.number_sender, type_op: @operation.type_op }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { number_owner: @operation.number_owner, number_sender: @operation.number_sender, type_op: @operation.type_op }
    assert_redirected_to operation_path(assigns(:operation))
  end
